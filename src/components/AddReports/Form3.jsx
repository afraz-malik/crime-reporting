  ...
  <div className={FormCss.container}>
   <form onSubmit={handleSubmit}>
    ...
    <label className={FormCss.lastlabel}>
     ...
     <span>
      I hereby verified the above information is correct and verified as per
      Terms & Conditions of Faculty Directory of Multi University
     </span>
    </label>
